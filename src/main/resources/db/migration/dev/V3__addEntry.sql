...
INSERT INTO product (id, name, subtitle, price, currency_id, brand_id, preview_image_id, category_id)
VALUES (1, 'Desperados Original', 'Tequila beer', 4.59, 1, 1, 1, 1);
...
VALUES (1, 3);
/*
INSERT INTO attribute_type (id, name, material_icon, data_type)
VALUES (1, 'distance', 'straighten', 'NUMBER_DECIMAL');

INSERT INTO unit (id, name, symbool, short_name)
VALUES (1, 'meter', 'm', 'meter');

INSERT INTO attribute_type_unit (attribute_type_id, unit_id)
VALUES (1, 1);
